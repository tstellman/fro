...
if (array_key_exists('Submit',$_POST)) {
    ...
    $email_subject = "Food Rescue Online Tech Support";
	...
	if (empty($errors)){
		...
		$email_message .= "Agency Number: ".clean_string($ProgramNumber)."\n";
...
?>
	...
	<h3 class="titlehdr">Tech Support Contact Page</h3>
		...
		<form name="contactform" method="post" action="contacttechsupport.php">
			<div class="cf">
