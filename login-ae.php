...
include '!_db.php';
if (isAuth()==false){
?><p>You are not Authed with AE</p><?php
} elseif (isAuth()==true){
?><p>You are Authed with AE</p><?php
} else {
?><p>No isAuth found</p><?php
}
...
<head>
	...
	<title>Welcome to Harvesters Grocery Store Recovery System</title>
	<meta name="description" content="Harvesters - The Community Food Network feeds hungry people today and works to end hunger tomorrow.">
	<meta name="author" content="Harvesters - The Community Food Network">
	<meta name="keywords" content="Harvesters, grocery store recovery, food bank, community food network, kansas city">
